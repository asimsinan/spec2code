...
🚨 CRITICAL: Use the data provided above, NOT files from the filesystem!
`;
...
## 📋 PHASE 1 TODO SUMMARY (32 ITEMS TOTAL)
**🚨 MANDATORY: Create TODO list for ALL 32 items before starting implementation!**

### Pre-Tasks (4 items)
- [ ] PRE-TASK-001: VERIFY Environment Setup
- [ ] PRE-TASK-002: VALIDATE Project Structure  
- [ ] PRE-TASK-003: CONFIRM Data Integrity
- [ ] PRE-TASK-004: INSTALL Dependencies

### Phase Tasks (25 items)
- [ ] TASK-001 to TASK-025: All foundation and data tasks

### Post-Tasks (3 items)
- [ ] POST-TASK-001: VALIDATE Code Quality
- [ ] POST-TASK-002: CONFIRM Functionality
- [ ] POST-TASK-003: VERIFY Integration

## 🚨 MANDATORY FIRST STEP: CREATE PHASE TODO LIST for following Tasks
### Pre-Tasks
...
## 📋 PHASE 2 TODO SUMMARY (27 ITEMS TOTAL)
**🚨 MANDATORY: Create TODO list for ALL 27 items before starting implementation!**
...
### Phase Tasks (20 items)
- [ ] TASK-026 to TASK-045: All application and core integration tasks
...
## 🚨 MANDATORY THIRD STEP: POST-TASKS VERIFICATION & VALIDATION
**AFTER ALL IMPLEMENTATION, YOU MUST COMPLETE VERIFICATION:**

### Post-Task TODO Creation
${this.generatePostTaskInstructions(phaseTasks, platform)}
...
## 📋 PHASE 3 TODO SUMMARY (22 ITEMS TOTAL)
**🚨 MANDATORY: Create TODO list for ALL 22 items before starting implementation!**
...
### Phase Tasks (15 items)
- [ ] TASK-046 to TASK-060: All API-first, platform and smoke tasks
...
**🚨 MANDATORY: Create TODO list for ALL 17 items before starting implementation!**
...
### Phase Tasks (10 items)
- [ ] TASK-061 to TASK-070: All full integration and verification tasks
